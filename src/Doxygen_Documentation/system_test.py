'''!
@file    system_test.py
@brief   This file is used to test the servos and obtained angles as well as signals correlations
...
def main():
	'''!
	@brief main file used to test for the behavior of the servos
	'''
